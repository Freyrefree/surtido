...
<div id="Imprime" >
      <table class="nota" style="text-align: center; ">
        <tr>
          <td colspan="4" ><h4>ELÈCTRICA FERRETERIA</h4><h2>"EL JEFE"</h2></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="4" align="right">XONACATLAN, MÈX. A. <?php echo $dia.' DE '.$mes.' DEL '.$year; ?></td>
        </tr>
        ...
        <tr>
          ...
          <td class="product"><?php echo $dato['nombre']; ?></td>
      ...
      <p><a href="IMP_contado.php?factura=<?php echo $factura; ?>&tipo=<?php echo $tipoventa; ?>&rfc=<?php echo $rfc; ?>" id="cmd" class="btn"><i class="icon-print"></i> Imprimir Factura</a></p>
<!-- ticket a imprimir -->
<!-- codigo imprimir 1-->
<!-- <center>
<div id="titulo"></div>
