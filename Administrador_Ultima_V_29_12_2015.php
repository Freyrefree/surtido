...
<table width="95%" border="0">
 ...
 <?php       
    if($_SESSION['tipo_usu']=='a'){
    echo'<a class="brand" href="empresa.php" target="admin"><img src="img/administrator.png"> Administrador</a>';
    }
  ?>  
          
          <a class="brand" href="caja.php?ddes=0" target="admin"><img src="img/total_plan_cost.png">Ventas</a>
          <ul class="nav" role="navigation">
            <li class="dropdown">
              <a id="drop1" href="#" role="button" class="brand" data-toggle="dropdown"><img src="img/group.png">Clientes y Proveedores <b class="caret"></b></a>
            ...
            <li class="dropdown">
              <a href="#" id="drop2" role="button" class="brand" data-toggle="dropdown"><img src="img/server_stanchion.png">Inventarios<b class="caret"></b></a>
            ...
            <!-- <li class="dropdown">
               <?php       
               if($_SESSION['tipo_usu']=='a'){
                echo'<a href="#" id="drop2" role="button" class="brand" data-toggle="dropdown"><img src="img/group.png">Empleados<b class="caret"></b></a> ';
                }
              ?>  
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
            ...
            <li class="dropdown">
               <?php       
               if($_SESSION['tipo_usu']=='a'){
                echo'<a href="#" id="drop2" role="button" class="brand" data-toggle="dropdown"><img src="img/total_plan_cost.png">Gastos<b class="caret"></b></a> ';
                }
              ?>  
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                <li role="presentation">
            ...
            <li class="dropdown">
               <?php        
               if($_SESSION['tipo_usu']=='a'){
                echo'<a href="#" id="drop2" role="button" class="brand" data-toggle="dropdown"><img src="img/report.png">Reportes<b class="caret"></b></a> ';
                }
              ?>  
              <ul class="dropdown-menu" role="menu" aria-labelledby="drop2">
                <li role="presentation">
