...
<div align="center" class="text">
    <table width="100%" border="0" bgcolor="#FFFFCC">
		<caption class="text"><strong>Listado de Clientes</strong></caption>
		  <tr>
			<td colspan="2" align="right"><a role="menuitem" tabindex="-1" href="PDFclientes.php" target="admin" ><img src="img/file_extension_pdf.png" width="32" height="32" boder ="0"  /></a></td>
		  </tr>
		</table><br />
