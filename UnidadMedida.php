...
<table width="100%" border="0">
  <tr>
    ...
    <div class="btn-group" data-toggle="buttons-checkbox">
        ...
        <button type="button" class="btn btn-primary" onClick="window.location='CrearUnidadMedida.php'">Ingresar Nuevo</button>
    </div>
    </td>
    <td>
    <div align="right">
...
<table width="80%" border="0" class="table">
  <tr class="info">
    <td colspan="7"><center><strong>Listado de Unidades de Medida</strong></center></td>
  </tr>
  <tr>
    <td width="5%"><strong>Codigo</strong></td>
    <td width="15%"><strong>Nombre</strong></td>
    <td width="7%"><strong>Abreviatura</strong></td>
    <td width="15%"><strong>equivalencia</strong></td>
  </tr>
    <?php 
	if(empty($_POST['bus'])){
		$can=mysql_query("SELECT * FROM unidad_medida");
