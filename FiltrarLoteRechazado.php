...
if($tipo_usu=="a"){
 if($IdLote==""){      
            $query2=mysql_query("SELECT * FROM movimientosxlote WHERE recibido=2");
      }else{
            $query2=mysql_query("SELECT * FROM movimientosxlote WHERE recibido=2 AND IdLote=$IdLote");
     }     
}else{
 if($IdLote==""){      
            $query2=mysql_query("SELECT * FROM movimientosxlote WHERE (IdSucSalida=$id_sucursal OR IdSucEntrada=$id_sucursal) AND recibido=2");
      }else{
            $query2=mysql_query("SELECT * FROM movimientosxlote WHERE (IdSucSalida=$id_sucursal OR IdSucEntrada=$id_sucursal) AND recibido=2 AND IdLote=$IdLote");
     }    
