...
$codigoTabla = tabularExcelCorteVentas($arrayConsultas,$rango_fecha,$tipoUsuario);
...
return $arrayConsultas;
    ...
    function tabularExcelCorteVentas($arrayConsultas, $rango_fecha, $tipoUsuario)
    {
