...
/*                        $("#resultado").html(response);*/
						window.location = 'PDFListaGastos.php?fecha_ini11='+fecha_i+'&fecha_fin11='+fecha_f;
                }
        });
...
<body><table width="100%" border="0" align="center" class="ui-widget-content ui-widget-header">
  <tr>
    <td align="center" style="font-size:14px">Reporte Gastos</td>
  </tr>
</table>
<p>
<table width="60%" border="0"  align="center">
  <tr>
    <td width="60%" height="19" align="center" class="ui-widget-content ui-corner-all"> <img src="../img/calendar_view_month.png" width="32" height="32"> Selecciona Fecha</td>
     ...
     <td width="37%" align="center" class="ui-widget-content ui-corner-all"><a href="#" onClick="consultagastos();" ><img src="../img/report.png" width="32" height="32">Consultar</a></td>
  </tr>
  ...
  <tr>
    ...
    <td width="37%"  class="ui-widget-content ui-state-hover" align="center"><a href="#" id="cmd" onClick="pdfgastos();" ><img src="../img/file_extension_pdf.png" width="32" height="32"> Exportar</a></td>
  </tr>
  <tr>
  	<p id="resultado"></p>
  </tr>
