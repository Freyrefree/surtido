						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class="container">
									...
									<div class="row">
										<div class="col-md-12">
											<p class="black font-weight-bold titulo text-center">REPORTE DE GASTOS</p>
										</div>
									</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
											<a href="#" onClick="pdfgastos();" class="red"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a>                    
                                        </div>
                                    </div>
									...
									<div class="row">
										...
										<div class="col-md-3"><br>
											<button type="button" class="btn btn-primary" onClick="consultagastos();" >Consultar</button>
